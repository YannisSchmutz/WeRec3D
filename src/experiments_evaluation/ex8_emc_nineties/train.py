...
EXPERIMENT_NAME = "ex8_emc_nineties"
DATA_VARIANT = "b"  # With seasonality
CHECKPOINT_FILE_PATH = "model_checkpoint/"
LOAD_WEIGHTS_PATH = "../ex5.1_elev_mov_cmi/model_checkpoint/p90/"
...
def main(percentage):
    ...
    mlflow.set_tag("mlflow.runName", f"emc_nineties_{percentage}p")
    ...
    with strategy.scope() if gpu_available else nullcontext():
        ...
        print(f"[*] Loading the weights of ex5.1-90%")
