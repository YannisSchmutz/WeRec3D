...
try:
    ...
    from src.data_loaders.generators import DataGenerator1, DataGenerator2
    ...
    from data_loaders.generators import DataGenerator1, DataGenerator2
...
EXPERIMENT_NAME = "ex3.1_moving_window"
...
def main(percentage, load_last):
    ...
    mlflow.set_tag("mlflow.runName", f"moving_window_{percentage}p")
    ...
    train_generator = DataGenerator2(X_train, y_train, batch_size=BS, seq_length=F,
