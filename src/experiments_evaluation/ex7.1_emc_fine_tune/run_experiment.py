...
EXPERIMENT_NAME = "ex7.1_emc_fine_tune"
DATA_VARIANT = "b"  # With seasonality
CHECKPOINT_FILE_PATH = "model_checkpoint/"

MISSING_TYPE = "mnar"
LOAD_WEIGHTS_PATH = "../ex5.1_elev_mov_cmi/model_checkpoint/p90/"  # Leading Method
PERCENTAGE = "99"


def main(percentage, load_weights_path):
    # SET MLFLOW dir
    ...
    mlflow.set_tag("mlflow.runName", f"emc_fine_tune_{percentage}p")
    ...
    with strategy.scope() if gpu_available else nullcontext():
        ...
        print(f"[*] Loading the weights of the leading method 90%")
...
if __name__ == '__main__':
    main(PERCENTAGE, LOAD_WEIGHTS_PATH)
